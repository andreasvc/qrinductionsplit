...
Old Fashioned Artificial Intelligence'' (GOFAI) approach, and in line with the	% cite GOFAI? Russell & Norvig
...
\subsection{Interdisciplinary relations}
...
\cite{dekleerdiag}), employing the user as an informant. A series of iterations
can be performed, presenting the resulting behavior graph to the user who can
then highlight errors.
...
(constraints). Negative exemplars are of course the very reason for the problem
of induction in philosophy. %cite?
