...
\item Finite-State automaton miniminization
...
%com.ves. can be splitted without an unfragment.
...
API, but this is also less straightforward than it should be. %FIXME remove this whining.
